...
!  Basic Hartree-Fock Proxy Application,  OpenMP parallel version 
...
!  for a cluster of helium-like atoms 
 ...
 !integer    ib,jb,kb,lb,  nn,kl,k,l  
 !integer    ib,jb,kb,lb,  kl,k,l  
 !real(8)    aij,dij,xij,yij,zij, akl,dkl, aijkl,tt,f0t, eri 
 !integer    nnnn,ijkl,n    !  need i8?
 !integer ijkl
 !INTEGER(INT64) :: n, nnnn, nn, ijkl
 !real(8)    aij,dij,xij,yij,zij, akl,dkl, aijkl,tt,f0t, eri 
 !integer ijkl
 !INTEGER(KIND=8) :: nnnn, n
 ...
 print *, "Range of nnnn: ", range(nnnn)
 print *, "Kind of nnnn: ", kind(nnnn)
 print *, "Size of nnnn in bytes: ", storage_size(nnnn)/8
...
! natom is the number of helium-like atoms.
 ...
 read *,  ( xpnt( i ), coef( i ), i = 1, ngauss )  !  read atomic basis set 
...
! such as GAMESS. Here, it is assumed that the density is output
! in triangular form.
!do  i  =  1,  natom    
!read *,  ( dens( i, j ), j = 1, i )  
!do  j  =  1,  i-1  
