#function bhfp_threads_lock(inputfile = get_input_filename_from_args();
#                           verbose = false)
#    (; ngauss, natom, xpnt, coef, geom) = parse_input_file(inputfile)
function bhfp_threads_lock(data; verbose=false)
    ...
    t = _kernel_threaded_lock!(fock, nn, schwarz, ngauss, xpnt, coef, geom, dens)
