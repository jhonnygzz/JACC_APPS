...
function MultiDintegrateStressForElems(domain::Domain, sigxx, sigyy, sigzz, determ)
    ...
    println("Time taken for update_domain: ", time2 - time1)
...
function MultiDcalcKinematicsForElems(domain::Domain, numElem, dt)
    ...
    println("Total average time taken for all functions on calcKinematicsForElems $num_runs runs: ", total_average_time)
