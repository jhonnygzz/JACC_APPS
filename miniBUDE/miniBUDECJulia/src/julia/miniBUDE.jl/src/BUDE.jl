...
@with_kw mutable struct Params
  device::String = "1"
  #evice::String = "2" #had to change it in order to detect the cuda and amdgpu device (on KernelAbstractions.jl)
  list::Bool = false
...
function main()
  ...
  poses = permutedims( # reshape is column order so we flip it back again
    reshape(
      ...
      #read_structs("../../../data/bm2/poses.in", Float32),
  ...
  deck = Deck(
    ...
    #read_structs("../../../data/bm2/protein.in", Atom),
    #read_structs("../../../data/bm2/ligand.in", Atom),
    #read_structs("../../../data/bm2/forcefield.in", FFParams),
    poses,
  )
  ...
  #ref_energies = open("../../../data/bm2/ref_energies.out", "r")
