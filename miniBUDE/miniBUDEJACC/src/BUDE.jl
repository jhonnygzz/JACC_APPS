# the authors probably decided to use lower precision (Float32) for the numerous 
# calculations where approximate results are acceptable, 
# but higher precision (Float64) for measurements and results where accuracy is more important.
